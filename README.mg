...
Perplexity AI Translator is a Tampermonkey script that translates selected text on web pages to Korean using Perplexity AI.

## Key Features

- Display translation button when text is selected on web pages
- High-quality translation using Perplexity AI
- Preserve line breaks in translation results
- Resolve encoding issues (remove broken characters)
- Hide translation button when Korean text is selected
